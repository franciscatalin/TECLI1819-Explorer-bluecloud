...
export class RegisterComponent extends TranslatableComponent implements OnInit {
  ...
  submitted = false;
  // Arrays que indican las opciones que tendrán el combo del rol y idioma dentro del formulario de registro
  ...
  ngOnInit() {
    this.registerForm = this.formBuilder.group
      ({
        name: [''],
        surname: [''],
        role: ['Explorer'], // Valores por defecto con los que se inicia el formulario
        password: [''],
        email: [''],
        countrycode: [''],
        phone: [''],
        address: [''],
        preferredLanguage: ['es'], // Valores por defecto con los que se inicia el formulario
      });
  }
